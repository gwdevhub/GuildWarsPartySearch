...
public interface IPartySearchDatabase
{
    ...
    Task<bool> SetPartySearches(Map map, List<PartySearchEntry> partySearch, CancellationToken cancellationToken);
    Task<List<PartySearchEntry>?> GetPartySearches(Map map, CancellationToken cancellationToken);
}
